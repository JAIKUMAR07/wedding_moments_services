    ...
    <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-amber-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/20 hover:-translate-y-2">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        {service.offer && (
          <div className="absolute top-4 right-4 z-10">
            <div className="relative overflow-hidden bg-linear-to-r from-red-600 to-rose-600 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg shadow-red-500/20 animate-pulse">
      ...
      <div className="p-6">
        ...
        <Link
          ...
          className="block w-full text-center px-6 py-3 bg-linear-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-full hover:from-amber-600 hover:to-amber-700 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/50 group-hover:scale-105"
        >
          View Services
        </Link>
      </div>
